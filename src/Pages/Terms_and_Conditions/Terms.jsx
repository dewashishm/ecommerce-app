...
function Terms() {
    return (
        <div>
            ...
            <div className='terms-middlepart'>
                <p className='license-header'>License Agreement</p>
                <p className='terms-para'>Your Rights Roxboro Lighting Limited trading as Onlinelightshop is a UK based company and complies with UK consumer law including the Distance Selling Regulations. This means that shopping with Onlinelightshop is safe. With 30 years experience in lighting retailing we aim to give a thorough and reliable service, you’ll get your items delivered and we’ll sort out any problems you have. Our Terms and Conditions do not affect your statutory rights. Distance Selling Regulations give you the right to cancel an order and return any goods that may already have been dispatched, (see Returns for Refund) up to 7 days from receipt. Our returns policy allows 21 days.</p>

                <p className='main-heading'>Sales terms and conditions</p>
                <p className='secondary-heading'>Pricing</p>

                <p className='terms-para'>Prices include VAT (Value Added Tax)*, standard UK rate 20%. VAT does not apply to orders that are to be shipped outside the E.U. or to Tax Free areas such as the Channel Islands. These areas will be priced and billed with VAT deducted. The prices on the site are shown including VAT.
                    ...
                    While we do our best to ensure prices are up to date and correct, errors may occur and in this case you will be contacted before your order is shipped.</p>

                <p className='secondary-heading'>Payment</p>
                <p className='terms-para'>Onlinelightshop accept most major credit cards for online orders. You will be asked to enter your card details and the name and the address of the card holder when you place the order. These details will be checked and we may hold an order until we receive the correct details. You will be contacted if we find the card or address details to be incorrect. We only bill your card when your order is ready to be dispatched.

                    For offline orders Onlinelightshop accept (£) Sterling Postal Orders, Personal Cheques, (£) Sterling Bank Drafts and (£) Sterling Bank Transfers. We recommend that you do not send cash through the post. Due to varying Exchange Rates all payments made to CRC must be in UK Pounds (£) Sterling.</p>

                <p className='secondary-heading'>Product Availability</p>
                <p className='terms-para'>Onlinelightshop endeavours to carry most of the items displayed on the site in stock. If an item you order is out of stock we will contact you with a due date. You may then wish to cancel the order or wait until the item becomes available.</p>

                <p className='secondary-heading'>Out of Stock Orders</p>
                ...
                <p className='secondary-heading'>Accuracy of Information</p>
                <p className='terms-para'>
                ...
                <p className='secondary-heading'>Changes</p>
                <p className='terms-para'>
                ...
                <p className='secondary-heading'>Price and Payment</p>
                <p className='terms-para'>The Price of the Goods shall be that stipulated on the Seller’s Website. The Price is NOT INCLUSIVE of VAT. The Price EXCLUDES delivery charges.
                    ...
                    Payment must be made by secure credit or debit transactions (please see Privacy Statement).</p>

                <p className='secondary-heading'>Warranty</p>
                <p className='terms-para'>The Seller warrants that the Goods will at the time of dispatch correspond to the description given by the Seller.
                    After 7 Working days from the date of delivery goods will be repaired or replaced dependant upon the nature of the fault.
                </p>

                <p className='secondary-heading'>Delivery</p>
                <p className='terms-para'>Goods supplied within the UK will normally be delivered within 3-5 working days of acceptance of order.
                    ...
                    Title and risk in the Goods shall pass to the Buyer upon delivery of the Goods.</p>

                <p className='secondary-heading'>Cancellation and Return</p>
                <p className='terms-para'>
